              ...
              border-success border-opacity-25 rounded">
                ...
                <div className="detail col-7 p-2">
                  <div className="info">
                    ...
                    <p>
                      {location.khach} khách - phòng studio <br />
                      {location.giuong} giường - {location.phongTam} phòng tắm <br />
                      {<span>{location.wifi}</span> ? <span>Wifi</span> : ""} - {''}
                      {<span>{location.bep}</span> ? <span>Bếp</span> : ""} - {''}
                      {<span>{location.dieuHoa}</span> ? <span>Điều hòa</span> : ""} - {''}
                      {<span>{location.mayGiat}</span> ? <span>Máy giặt</span> : ""}
                    </p>
                  </div>
